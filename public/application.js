...
/***/ function(module, exports, __webpack_require__) {
	...
	var engineEvents = __webpack_require__(13);
...
/***/ function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    ...
	    production: 'https://boiling-gorge-32374.herokuapp.com/'
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onChangePW = function onChangePW(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.changePW(data).then(ui.changePWSuccess).catch(ui.changePWFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(module) {// This file is used for storage of the players global objects
	// It is populated via the sign in and sign up features
	// The players function is used whenever we need player data
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {// This file is responsible for the success and failure functions of the API Calls
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetSongs = function onGetSongs(event) {
	  event.preventDefault();
	...
	// This function is run when the get song button is pushed
	// It makes an API call to get the songs
	var onGetSongsNew = function onGetSongsNew() {
	  console.log('test');
	  api.getSongs().then(ui.getSongsSuccess).catch(ui.getSongsFailure);
	};
	...
	var onGetLyrics = function onGetLyrics(data) {
	...
	var translate = function translate(event) {
	  ...
	  for (var i = 0; i < lyrics.lyric.translation.length; i++) {
	...
	var updateSong = function updateSong(data) {
	...
	var deleteSong = function deleteSong(id, data) {
	...
	// Exports for use in main index file
	module.exports = {
	  addHandlers: addHandlers, updateSong: updateSong, deleteSong: deleteSong, onGetSongsNew: onGetSongsNew, onGetLyrics: onGetLyrics
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addSong = function addSong(data) {
	  return $.ajax({
	...
	var getLyrics = function getLyrics(data) {
	  return $.ajax({
	...
	module.exports = {
	  addSong: addSong, getSongs: getSongs, getLyrics: getLyrics, updateSong: updateSong, deleteSong: deleteSong
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var users = __webpack_require__(10);
	var songs = __webpack_require__(16);
	var lyrics = __webpack_require__(17);
	var getFormFields = __webpack_require__(8);

	// Show songs if we can get them
	var getSongsSuccess = function getSongsSuccess(data) {
	  songs.song = data;
	  ...
	  var _loop = function _loop(i) {
	    ...
	    if (data.songs[i].user_id === users.user.user.id) {
	      ...
	      '<form id=' + data.songs[i].id + '>' + '<input type="text" name="song[artist]" id="add-song-name" placeholder="Enter Artist Name">' + '<input type="text" name="song[name]" id="add-song-name" placeholder="Enter Song Name">' + '<input type="text" name="song[album]" id="add-song-album" placeholder="Enter Album Name">' + '<input type="submit" id=' + data.songs[i].id + ' class="btn btn-primary btn-top" name="submit" value="Update a Song">' +
	      // Append HTML for deletes
	      '</form>' + '<form id =del' + data.songs[i].id + '><input type="submit" class="btn btn-primary btn-top" name="submit" value="Delete This Song">' + '</form></span>' + '<br />' +
	...
	var addSongSuccess = function addSongSuccess(data) {
	  var events = __webpack_require__(13);
	  // Show song info
	  $('#TEST').empty();
	  $('.song_msg').text('You added ' + data.song.name + ' with an ID of ' + data.song.id);
	  // Append all song data (see get songs)
	  $('.show-songs').append('<span id = span' + data.song.id + '>Song Title: ' + data.song.name + ' Song ID: ' + data.song.id + ' on album ' + data.song.album + ' by ' + data.song.artist + '<form id=' + data.song.id + '>' + '<input type="text" name="song[artist]" id="add-song-name" placeholder="Enter Artist Name">' + '<input type="text" name="song[name]" id="add-song-name" placeholder="Enter Song Name">' + '<input type="text" name="song[album]" id="add-song-album" placeholder="Enter Album Name">' + '<input type="submit" id=' + data.song.id + ' class="btn btn-primary btn-top" name="submit" value="Update a Song">' + '</form>' + '<form id =del' + data.song.id + '><input type="submit" class="btn btn-primary btn-top" name="submit" value="Delete This Song">' + '</form></span>' + '<br />' + '<form id=lyrics' + data.song.id + '><input type="submit" class="btn btn-primary" name="submit" value="Get Lyrics">');
	...
	var getLyricsFailure = function getLyricsFailure(data) {
	  $('.add_lyrics').text('There was a problem getting your lyrics.  If you entered a non-English song, check for non-ASCII characters.' + 'If you entered an English song, check your spelling and make sure the song, artist and album line up.');
	};

	// If update song call is a success, append the data to HTML
	// Then run get songs to refresh the list
	var updateSongSuccess = function updateSongSuccess(data) {
	  var events = __webpack_require__(13);
	...
	var deleteSongFailure = function deleteSongFailure(data) {
	  $('.song_msg').text('There was a problem deleting this song');
	};

	module.exports = {
	  deleteSongSuccess: deleteSongSuccess,
	  deleteSongFailure: deleteSongFailure,
	  getSongsSuccess: getSongsSuccess,
	  getSongsFailure: getSongsFailure,
	  getLyricsFailure: getLyricsFailure,
	  getLyricsSuccess: getLyricsSuccess,
	  addSongSuccess: addSongSuccess,
	  addSongFailure: addSongFailure,
	  updateSongSuccess: updateSongSuccess,
	  updateSongFailure: updateSongFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(module) {// This file is used for storage of the songs global objects
	// It is populated via the sign in and sign up features
	// The songs function is used whenever we need song data
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(module) {// This file is used for storage of the lyrics global objects
	// It is populated via the sign in and sign up features
	// The lyrics function is used whenever we need lyric data

	'use strict';

	var lyrics = {};

	module.export = lyrics;
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(11)(module)))
